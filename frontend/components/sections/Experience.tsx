...
const experiences = [
  {
    ...
    description:
      "Lideré el diseño y desarrollo de una plataforma ERP a medida para un Centro de Servicio Autorizado Samsung. La solución optimiza integralmente el ciclo de vida de las órdenes de soporte técnico para equipos de línea blanca y electrónica, reemplazando sistemas heredados con una arquitectura MVC moderna, rápida y confiable.",
    achievements: [
      "Desarrollo End-to-End: Diseño completo de la aplicación bajo arquitectura MVC, desde el modelado de la base de datos relacional hasta la implementación de una UI responsiva.",
      "Optimización Operativa: Digitalización de la gestión de inventarios y órdenes de servicio, eliminando redundancias y mejorando significativamente la velocidad de respuesta del centro.",
      "Seguridad Avanzada: Implementación de autenticación segura (JWT), validación de datos (Zod) y control de acceso basado en roles (RBAC) para proteger la integridad de la información.",
      "Reportes y Métricas: Integración de herramientas para la generación de reportes técnicos automatizados en PDF y visualización de datos de rendimiento con Recharts.",
      "Despliegue y Escalabilidad: Configuración de entornos de base de datos con Supabase y despliegue continuo, garantizando alta disponibilidad y escalabilidad del sistema.",
    ],
    technologies: [
      "React",
      "Next.js",
